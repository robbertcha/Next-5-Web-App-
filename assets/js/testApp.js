...
angular.module('testApp').constant('site_url', 'http://localhost/next_five/');


testApp.directive( 'tooltipPopup', function () {
    return {
      restrict: 'E',
      replace: true,
      template: '<div class="tooltip {{placement}}" ng-class="{ in: isOpen, fade: animation() }"><div class="tooltip-arrow"></div> <div class="tooltip-inner" ng-bind="tooltipTitle"></div></div>'
    };
  })
